...
$this->title = 'Coordenacoes';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="Coordenacoes-index">
    ...
    <?php
        Modal::begin([
             'id'=>'modal-id-ver',
             'header'=>'<h1>Detalhes da coordenação</h1>',
             'size'=>'modal-lg',
            ]);
    ...
    <?php
        Modal::begin([
         'id'=>'modal-id-editar',
         'header'=>'<h1>Editar coordenação</h1>',
         'size'=>'modal-lg',
            ]);
    ...
    <div class="box">
        ...
        <p style="float: left; margin-bottom: 0px">
                <?= Html::button('Adicionar', ['value'=>URL::to('index.php?r=coordenacoes/create'), 'class' => 'btn btn-primary', 'id'=>'AddButton']) ?>
        </p>
        <br>
        <br>
        <br>
