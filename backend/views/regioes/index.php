...
?>
<div class="regioes-index">

    <?php
        Modal::begin([
        'id' => 'modal-add',
        'header'=>'<h1>Adicionar região</h1>',          
        'size' => 'modal-lg',
        ]);
    ...
    <?php
        Modal::begin([
         'id'=>'modal-id-ver',
         'header'=>'<h1>Detalhes da região</h1>',
         'size'=>'modal-lg',
            ]);
    ...
    <div class="box">
        ...
        <p style="float: left; margin-bottom: 0px">
                <?= Html::button('Adicionar', ['value'=>URL::to('index.php?r=regioes/create'), 'class' => 'btn btn-primary', 'id'=>'AddButton']) ?>
        </p>
        <br>
        <br>
        <br>
            ...
            <?= DynaGrid::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute'=>'coordenacao_id_coordenacao',
                        'value'=> 'coordenacaoIdCoordenacao.nome',
                        'hAlign'=>'left', 
                        'vAlign'=>'middle',
                        'width'=>'150px',
                        'pageSummary'=>true
                    ...
                    ['class'=>'kartik\grid\ActionColumn','template'=> '{view}{update}',
                        'buttons' => [
                                ...
                                'update' => function ($url, $model) {
                                 ...
                                 ['value' => $url, 'onclick' => 'js:openPopUpEditar(this);', 'title' => 'Atualizar região']);
