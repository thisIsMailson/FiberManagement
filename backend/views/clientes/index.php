...
<div class="clientes-index">
  <?php
        Modal::begin([
            'id' => 'modal-id-ver',
         'header' => '<h1>Detalhes do Cliente</h1>',
            'size' => 'modal-lg',
        ]);
    ...
    <?php
        Modal::begin([
         'id'=>'modal-id-createPdd',
         'header' => '<h1>Associar Pedido</h1>',
         'size'=>'modal-lg',
            ]);
        echo "<div id='modalContentCreatePdd'></div>";
        Modal::end()
    ?>
        ...
        <div class="box-body">
            ...
            <?= DynaGrid::widget([
                ...
                'columns' => [
                    ...
                    ['class'=>'kartik\grid\ActionColumn','template'=> '{view}{update}{pedido}',
                        'buttons' => [
                                ...
                                'update' => function ($url, $model) {
                                    ...
                                    return $userRole == 2 ? Html::a('<span class="glyphicon glyphicon-pencil" style="padding: 10px;"></span>', FALSE, 
                                 ['value' => $url, 'onclick' => 'js:openPopUpEditar(this);', 'title' => 'Adicionar adenda']) : '';
                                    
                                },
                                'pedido' => function ($url, $model) {
                                    $userLoged = \Yii::$app->user->identity;
                                    $userRole = $userLoged->role_id;
                                    return $userRole == 2 ? Html::a('<span class="glyphicon glyphicon-plus"></span>', FALSE, 
                                 ['value' => $url, 'onclick' => 'js:openCreatePddPopUp(this);', 'title' => 'Adicionar pedido']) : '';
