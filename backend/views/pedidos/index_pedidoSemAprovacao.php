...
$this->title = 'Pedidos sem aprovação';
$this->params['breadcrumbs'][] = 'Pedidos Sem Aprovação';
?>
<style type="text/css">
    #zonas-drop {
        width: 2px !important;
           ...
           <div id="pedidos-lista">
               <?= DynaGrid::widget([
                    ...
                    'columns' => [
                        ...
                        ['class'=>'kartik\grid\ActionColumn','template'=> '{view}{statussemdesponibilidade}{historico}',
                            'buttons' => [
                                    ...
                                    'statussemdesponibilidade' => function ($url, $model) {
                                        return Html::a('<span class="glyphicon glyphicon-pencil" style="padding-left: 10px;"></span>', FALSE, 
