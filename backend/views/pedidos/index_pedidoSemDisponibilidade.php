...
$this->title = 'Pedidos sem disponibilidade';
$this->params['breadcrumbs'][] = 'Pedidos Sem Disponibilidade';
?>
<style type="text/css">
    #zonas-drop {
        width: 2px !important;
           ...
           <div id="pedidos-lista">
               <?= DynaGrid::widget([
                    ...
                    'columns' => [
                        ...
                        ['class'=>'kartik\grid\ActionColumn','template'=> '{view}{statussemdesponibilidade}{projeto}',
                            'buttons' => [
                                    'view' => function ($url, $model) {
                                        return Html::a('<span class="glyphicon glyphicon-eye-open" ></span>', FALSE, 
                                     ['value' => $url, 'onclick' => 'js:openPopUp(this);', 'title' => 'Ver']);
                                    },
                                    'statussemdesponibilidade' => function ($url, $model) {
                                        $userLoged = \Yii::$app->user->identity;
                                        $userRole = $userLoged->role_id;
                                        return $userRole == 5 || $userRole == 1 ? Html::a('<span class="glyphicon glyphicon-pencil" style="padding: 10px;"></span>', FALSE, 
                                    ...
                                    'projeto' => function ($url, $model) {
                                        $userLoged = \Yii::$app->user->identity;
                                        $userRole = $userLoged->role_id;
                                        return $userRole == 5 ? Html::a('<span class="glyphicon glyphicon-briefcase"></span>', FALSE, 
